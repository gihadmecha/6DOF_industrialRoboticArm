...
if(Serial.available()>=5 ) {
   ...
   //motor 1    
  if(rec_data[0]!=1 && rec_data[0]>=M1_Min_Limit && rec_data[0]<=M1_Max_Limit){
 if( rec_data[0]>=stepper1.currentPosition()) stepper1.runToNewPosition(rec_data[0]);
   ...
   //motor 2     
  if(rec_data[1]!=1 &&rec_data[1]>=M2_Min_Limit && rec_data[1]<=M2_Max_Limit){
 if( rec_data[1]>=stepper2.currentPosition()) stepper2.runToNewPosition(rec_data[1]);
   ...
   //motor 3    
  if(rec_data[2]!=1 &&rec_data[2]>=M3_Min_Limit && rec_data[2]<=M3_Max_Limit){
 if( rec_data[2]>=stepper3.currentPosition()) stepper3.runToNewPosition(rec_data[2]);
   ...
   //motor 4 
  if(rec_data[3]!=1 &&rec_data[3]>=M4_Min_Limit && rec_data[3]<=M4_Max_Limit){
 if( rec_data[3]>=stepper4.currentPosition()) stepper4.runToNewPosition(rec_data[3]);
   ...
   //motor 5
if(rec_data[4]!=1 &&rec_data[4]>=M5_Min_Limit && rec_data[4]<=M5_Max_Limit){
 if( rec_data[4]>=stepper5.currentPosition()) stepper5.runToNewPosition(rec_data[4]);
   ...
   //motor 6
if(rec_data[5]!=1  &&rec_data[5]>=M6_Min_Limit && rec_data[5]<=M6_Max_Limit){
