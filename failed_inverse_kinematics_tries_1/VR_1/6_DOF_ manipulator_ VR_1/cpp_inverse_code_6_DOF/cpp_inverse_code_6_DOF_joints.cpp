...
float R0_6[3][3]; //declare the desired orientation matrix
...
int main ()
{
    ...
    {  //Enter the desired position
       ...
       float th2=ph1-ph4;                           //theta_2 in radianæ the first or fourth quadrature
       float th3=ph2-(pi/2);                        //theta_3 in radianæ the first or second quadrature
      ...
      cout << "theta_3 =  " <<th3<<endl;
       ...
       float R1_2[3][3] = { {cos(th2), -sin(th2),     0   },
                            {sin(th2), cos(th2),      0   },
                            {0       ,    0     ,     1   }   };
       float R2_3[3][3] = { {cos(th3),    0,       sin(th3)} ,
                            {sin(th3),    0,      -cos(th3)} ,
                            {0       ,    1,          0   }   };
        ...
        for(int j = 0; j < 3; ++j)
         {
            ...
            for(int n = 0; n < 3; ++n)
             {
                R3_6[i][j] = R3_6[i][j] + R0_3[i][n] * R0_6[n][j];
             }
         }
         //print R3_6
      cout<<endl;
     ...
     float th5 = acos(R3_6[2][2]);
     float th4 = acos((-R3_6[0][2])/sin(th5));
     float th6 = acos(R3_6[2][0]/sin(th5));
      ...
      cout << "theta_6 =  " <<th6<<endl;
      cout << endl;


      //get R3_6_check matrix
      //note: it's a check matrix, use other solutions for th1, th2, th3 up in comments if R3_6 != R3_6_check
      float R3_6_check[3][3] = {{cos(th4)*cos(th5)*cos(th6)-sin(th4)*sin(th6) ,   -cos(th4)*cos(th5)*sin(th6)-sin(th4)*cos(th6)   ,    -cos(th4)*sin(th5)},
